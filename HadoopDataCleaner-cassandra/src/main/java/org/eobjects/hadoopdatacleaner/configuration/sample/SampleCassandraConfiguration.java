...
public class SampleCassandraConfiguration {
    ...
    public static AnalyzerBeansConfiguration buildAnalyzerBeansConfiguration() {
        ...
        SimpleTableDef tableDef1 = new SimpleTableDef("countrycodes", new String[] { "country_name", "iso2", "iso3" });
        SimpleTableDef tableDef2 = new SimpleTableDef("countrycodes_output", new String[] { "country_name",
                "iso2", "iso3" });
        ...
        Datastore datastore = new PojoDatastore("countrycodes_cassandra", "countrycodes_schema", tableDataProviders);
    ...
    public static AnalysisJob buildAnalysisJob(AnalyzerBeansConfiguration configuration) {
        ...
        try {
            ajb.setDatastore("countrycodes_cassandra");

            ajb.addSourceColumns("countrycodes_schema.countrycodes.country_name",
                    "countrycodes_schema.countrycodes.iso2",
                    "countrycodes_schema.countrycodes.iso3");

            TransformerJobBuilder<ConcatenatorTransformer> concatenator = ajb
                    .addTransformer(ConcatenatorTransformer.class);
            concatenator.addInputColumns(ajb.getSourceColumnByName("iso2"));
            concatenator.addInputColumns(ajb.getSourceColumnByName("iso3"));
            concatenator.setConfiguredProperty("Separator", "_");
            concatenator.getOutputColumns().get(0).setName("iso2_iso3");
            
            FilterJobBuilder<EqualsFilter, ?> equalsFilter = ajb.addFilter(EqualsFilter.class);
            equalsFilter.addInputColumn(ajb.getSourceColumnByName("iso2"));
            equalsFilter.setConfiguredProperty("Column", ajb.getSourceColumnByName("iso2"));
            ...
            valueDistributionAnalyzer.addInputColumn(ajb.getSourceColumnByName("country_name"));
            ...
            valueDistributionAnalyzer2.addInputColumn(ajb.getSourceColumnByName("iso2"));
            ...
            stringAnalyzer.addInputColumn(ajb.getSourceColumnByName("iso3"));

            AnalyzerJobBuilder<InsertIntoTableAnalyzer> insertInto = ajb.addAnalyzer(InsertIntoTableAnalyzer.class);
            insertInto.setConfiguredProperty("Column names", new String[] { "iso2" });
            ...
            insertInto.setConfiguredProperty("Datastore",
                    configuration.getDatastoreCatalog().getDatastore("countrycodes_cassandra"));
