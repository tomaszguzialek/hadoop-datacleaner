 ...
 */
package org.eobjects.hadoopdatacleaner.job.tasks;
...
/**
 * A class (task) that dispatches ("consumes") a record to all relevant
 * {@link RowProcessingConsumer}s (eg. analyzerbeans components).
 * 
 * Modified version of Datacleaner ConsumeRowTask
 * (org.eobjects.datacleaner.job.tasks.ConsumeRowTask) to obtain the row after
 * transforming (get the result record).
 */
public final class ConsumeRowTask implements RowProcessingChain {
