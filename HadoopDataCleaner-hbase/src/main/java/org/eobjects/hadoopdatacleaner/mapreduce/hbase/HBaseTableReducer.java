...
//	private static final Log LOG = LogFactory.getLog(HBaseTableReducer.class);
...
//        LOG.info("analyzerKey = " + analyzerKey.toString() + " rows: ");
